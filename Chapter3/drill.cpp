...
/*
        Write a program that produces a simple 
        form letter based on user input.
*/
...
int main()
{
        ...
        std::cout << "Enter the name of the person" 
                << " you want to write to (followed by 'enter'):\n";
        std::cin >> first_name;
        ...
        std::cout << "Enter the name of another friend"
                << " (followed by 'enter'):\n";
        std::cin >> friend_name;
        std::cout << "Is this friend male or female?" 
                << " (type m/f followed by 'enter'):\n";
        std::cin >> friend_sex;
        std::cout << "Dear " << first_name 
                << ",\n\tHow are you? Here everything is ok,"
                << " I miss you so much.\n";
